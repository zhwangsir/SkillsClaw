...
> Prerequisites: see root `../SKILL.md` for setup, credentials, `get-token.sh`/`get-token.ps1`, and `ima_api()` helper.
...
PREFLIGHT=$(node <SKILL_DIR>/knowledge-base/scripts/preflight-check.cjs \
